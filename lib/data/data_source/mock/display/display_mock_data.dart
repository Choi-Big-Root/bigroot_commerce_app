class DisplayMockData {
  static const String menusByMarket =
      '[{"title":"BIG 추천","tabId":10001},{"title":"신상품","tabId":10002},{"title":"베스트","tabId":10003},{"title":"알뜰쇼핑","tabId":10004},{"title":"특가/혜택","tabId":10005}]';

  static const String menusByBeauty =
      '[{"title":"BIG 추천","tabId":20001},{"title":"페스티벌","tabId":20002},{"title":"신상품","tabId":20003},{"title":"베스트","tabId":20004},{"title":"브랜드관","tabId":20005}]';

  static const String viewModulesByTabIdCaseOne =
      '[{"type":"ViewModuleA"},{"type":"ViewModuleB"},{"type":"ViewModuleC"},{"type":"ViewModuleD"},{"type":"ViewModuleE"}]';
  static const String viewModulesByTabIdCaseTwo =
      '[{"type":"ViewModuleB"},{"type":"ViewModuleC"},{"type":"ViewModuleD"},{"type":"ViewModuleE"},{"type":"ViewModuleA"}]';
  static const String viewModulesByTabIdCaseThree =
      '[{"type":"ViewModuleC"},{"type":"ViewModuleD"},{"type":"ViewModuleE"},{"type":"ViewModuleA"},{"type":"ViewModuleB"}]';
  static const String viewModulesByTabIdCaseFour =
      '[{"type":"ViewModuleD"},{"type":"ViewModuleE"},{"type":"ViewModuleA"},{"type":"ViewModuleB"},{"type":"ViewModuleC"}]';
  static const String viewModulesByTabIdCaseFive =
      '[{"type":"ViewModuleE"},{"type":"ViewModuleA"},{"type":"ViewModuleB"},{"type":"ViewModuleC"},{"type":"ViewModuleD"}]';

  //Product Info Mock data
  static final String productInfo = '''{
        "productId": "${DateTime.now().microsecondsSinceEpoch}",
        "title":"BigRoot 샘플 상품의 타이틀 입니다. 긴 문자를 노출했을 시 화면에서는 오버플로우가 발생할 수 있어 반드시 체크를 해야합니다.",
  ...
  static String getViewModules() {
    ...
    final products = List.filled(6, productInfo);
